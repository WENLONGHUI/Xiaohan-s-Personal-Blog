---
title: Markdown语法与外挂标签写法汇总  # 【核心】文章标题（必填）
description: 🥧本文汇总Markdown格式以及外挂标签在网页端的渲染效果，可作为文档进行查询 # 【SEO】文章描述（会显示在搜索引擎结果中）
mathjax: true # 【扩展】启用数学公式渲染（需主题支持）
tags:   # 【分类】标签系统（支持多个标签）
  - Markdown
  - 外挂标签
categories:    # 【分类】目录分类（支持层级结构）
  - 工具
abbrlink: 2013454d  # 【优化】文章永久链接（需hexo-abbrlink插件）
sticky: 2           # 【主题】置顶优先级（数值越大越靠前）
swiper_index: 1     # 【主题】轮播图排序（Butterfly特色功能）
date: 2022-08-09 18:19:03  # 【核心】文章创建时间（自动生成可修改）
updated: 2022-10-23 22:00:00  # 【扩展】最后更新时间（需主题支持时间显示）
---
